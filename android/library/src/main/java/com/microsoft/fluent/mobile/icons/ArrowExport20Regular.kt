...
public val FluentIcons.Regular.ArrowExport20: ImageVector
  get() {
    if (_arrowExport20 != null) {
      return _arrowExport20!!
    }
    _arrowExport20 = fluentIcon(name = "Regular.ArrowExport20", 20f) {
      materialPath {
          moveTo(2.5F, 4.0F)
...
private var _arrowExport20: ImageVector? = null
