...
public val FluentIcons.Regular.ArrowStepInDiagonalDownLeft16: ImageVector
  get() {
    if (_arrowStepInDiagonalDownLeft16 != null) {
      return _arrowStepInDiagonalDownLeft16!!
    }
    _arrowStepInDiagonalDownLeft16 = fluentIcon(name = "Regular.ArrowStepInDiagonalDownLeft16", 16f) {
      materialPath {
