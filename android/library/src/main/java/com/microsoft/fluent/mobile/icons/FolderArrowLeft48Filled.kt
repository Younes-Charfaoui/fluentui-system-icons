...
public val FluentIcons.Filled.FolderArrowLeft48: ImageVector
  get() {
    if (_folderArrowLeft48 != null) {
      return _folderArrowLeft48!!
    }
    _folderArrowLeft48 = fluentIcon(name = "Filled.FolderArrowLeft48", 48f) {
      materialPath {
          moveTo(4.0F, 12.25F)
          ...
          horizontalLineToRelative(13.794F)
          curveTo(22.75F, 38.98F, 22.0F, 36.577F, 22.0F, 34.0F)
