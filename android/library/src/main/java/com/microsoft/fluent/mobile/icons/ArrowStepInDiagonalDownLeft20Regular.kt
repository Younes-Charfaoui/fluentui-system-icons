...
public val FluentIcons.Regular.ArrowStepInDiagonalDownLeft20: ImageVector
  get() {
    if (_arrowStepInDiagonalDownLeft20 != null) {
      return _arrowStepInDiagonalDownLeft20!!
    }
    _arrowStepInDiagonalDownLeft20 = fluentIcon(name = "Regular.ArrowStepInDiagonalDownLeft20", 20f) {
      materialPath {
