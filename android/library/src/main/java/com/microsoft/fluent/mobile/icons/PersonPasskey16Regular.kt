...
public val FluentIcons.Regular.PersonPasskey16: ImageVector
  get() {
    if (_personPasskey16 != null) {
      return _personPasskey16!!
    }
    _personPasskey16 = fluentIcon(name = "Regular.PersonPasskey16", 16f) {
      materialPath {
          moveTo(4.5F, 8.0F)
          horizontalLineToRelative(5.825F)
          curveToRelative(0.056F, 0.356F, 0.17F, 0.693F, 0.332F, 1.0F)
          horizontalLineTo(4.5F)
          curveTo(4.224F, 9.0F, 4.0F, 9.224F, 4.0F, 9.5F)
          verticalLineTo(10.0F)
          curveToRelative(0.0F, 1.438F, 1.432F, 3.0F, 4.0F, 3.0F)
          curveToRelative(1.506F, 0.0F, 2.621F, -0.537F, 3.286F, -1.272F)
