...
public val FluentIcons.Filled.NumberCircle716: ImageVector
  get() {
    if (_numberCircle716 != null) {
      return _numberCircle716!!
    }
    _numberCircle716 = fluentIcon(name = "Filled.NumberCircle716", 716f) {
      materialPath {
          moveTo(1.0F, 8.0F)
          ...
          curveTo(10.373F, 5.114F, 10.195F, 5.0F, 10.0F, 5.0F)
...
private var _numberCircle716: ImageVector? = null
