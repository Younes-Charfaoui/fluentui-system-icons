...
public val FluentIcons.Regular.LayoutColumnTwoSplitLeft16: ImageVector
  get() {
    if (_layoutColumnTwoSplitLeft16 != null) {
      return _layoutColumnTwoSplitLeft16!!
    }
    _layoutColumnTwoSplitLeft16 = fluentIcon(name = "Regular.LayoutColumnTwoSplitLeft16", 16f) {
      materialPath {
          moveTo(2.0F, 4.5F)
