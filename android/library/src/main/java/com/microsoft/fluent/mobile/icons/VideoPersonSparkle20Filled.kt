...
public val FluentIcons.Filled.VideoPersonSparkle20: ImageVector
  get() {
    if (_videoPersonSparkle20 != null) {
      return _videoPersonSparkle20!!
    }
    _videoPersonSparkle20 = fluentIcon(name = "Filled.VideoPersonSparkle20", 20f) {
      materialPath {
          ...
          reflectiveCurveTo(11.38F, 6.0F, 10.0F, 6.0F)
          reflectiveCurveTo(7.5F, 7.12F, 7.5F, 8.5F)
          reflectiveCurveTo(8.62F, 11.0F, 10.0F, 11.0F)
          close()        
      }
    }
    return _videoPersonSparkle20!!
