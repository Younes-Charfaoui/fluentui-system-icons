...
public val FluentIcons.Regular.LineFlowDiagonalUpRight16: ImageVector
  get() {
    if (_lineFlowDiagonalUpRight16 != null) {
      return _lineFlowDiagonalUpRight16!!
    }
    _lineFlowDiagonalUpRight16 = fluentIcon(name = "Regular.LineFlowDiagonalUpRight16", 16f) {
      materialPath {
          ...
          reflectiveCurveTo(6.0F, 10.672F, 6.0F, 11.5F)
          reflectiveCurveTo(5.328F, 13.0F, 4.5F, 13.0F)
          reflectiveCurveTo(3.0F, 12.328F, 3.0F, 11.5F)
          close()        
      }
    }
    return _lineFlowDiagonalUpRight16!!
