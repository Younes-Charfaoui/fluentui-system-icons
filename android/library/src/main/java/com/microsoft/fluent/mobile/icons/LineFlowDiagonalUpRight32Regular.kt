...
public val FluentIcons.Regular.LineFlowDiagonalUpRight32: ImageVector
  get() {
    if (_lineFlowDiagonalUpRight32 != null) {
      return _lineFlowDiagonalUpRight32!!
    }
    _lineFlowDiagonalUpRight32 = fluentIcon(name = "Regular.LineFlowDiagonalUpRight32", 32f) {
      materialPath {
          ...
          close()
          moveTo(5.0F, 23.5F)
          curveTo(5.0F, 21.567F, 6.567F, 20.0F, 8.5F, 20.0F)
          reflectiveCurveToRelative(3.5F, 1.567F, 3.5F, 3.5F)
          reflectiveCurveTo(10.433F, 27.0F, 8.5F, 27.0F)
          reflectiveCurveTo(5.0F, 25.433F, 5.0F, 23.5F)
          close()        
      }
    }
    return _lineFlowDiagonalUpRight32!!
