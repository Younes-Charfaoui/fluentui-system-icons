...
public val FluentIcons.Regular.FolderArrowUp32: ImageVector
  get() {
    if (_folderArrowUp32 != null) {
      return _folderArrowUp32!!
    }
    _folderArrowUp32 = fluentIcon(name = "Regular.FolderArrowUp32", 32f) {
      materialPath {
          moveTo(4.0F, 8.5F)
          ...
          reflectiveCurveTo(25.0F, 28.164F, 25.0F, 27.75F)
          verticalLineToRelative(-7.69F)
          close()        
      }
    }
...
private var _folderArrowUp32: ImageVector? = null
