...
public val FluentIcons.Filled.TableSparkle20: ImageVector
  get() {
    if (_tableSparkle20 != null) {
      return _tableSparkle20!!
    }
    _tableSparkle20 = fluentIcon(name = "Filled.TableSparkle20", 20f) {
      materialPath {
          ...
          close()
          moveTo(9.09F, 3.0F)
          curveTo(9.03F, 3.158F, 9.0F, 3.326F, 9.0F, 3.497F)
          curveTo(9.0F, 3.792F, 9.091F, 4.08F, 9.262F, 4.32F)
