...
public val FluentIcons.Filled.ClipboardBulletList20: ImageVector
  get() {
    if (_clipboardBulletList20 != null) {
      return _clipboardBulletList20!!
    }
    _clipboardBulletList20 = fluentIcon(name = "Filled.ClipboardBulletList20", 20f) {
      materialPath {
          moveTo(7.085F, 3.0F)
          ...
          reflectiveCurveToRelative(0.336F, -0.75F, 0.75F, -0.75F)
          reflectiveCurveTo(8.0F, 14.086F, 8.0F, 14.5F)
          reflectiveCurveToRelative(-0.336F, 0.75F, -0.75F, 0.75F)
          close()        
      }
    }
