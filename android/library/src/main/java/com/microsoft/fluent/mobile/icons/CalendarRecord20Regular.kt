...
public val FluentIcons.Regular.CalendarRecord20: ImageVector
  get() {
    if (_calendarRecord20 != null) {
      return _calendarRecord20!!
    }
    _calendarRecord20 = fluentIcon(name = "Regular.CalendarRecord20", 20f) {
      materialPath {
          moveTo(14.5F, 3.0F)
          ...
          reflectiveCurveTo(16.433F, 18.0F, 14.5F, 18.0F)
          reflectiveCurveTo(11.0F, 16.433F, 11.0F, 14.5F)
...
private var _calendarRecord20: ImageVector? = null
