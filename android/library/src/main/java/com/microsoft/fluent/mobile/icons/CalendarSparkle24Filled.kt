...
public val FluentIcons.Filled.CalendarSparkle24: ImageVector
  get() {
    if (_calendarSparkle24 != null) {
      return _calendarSparkle24!!
    }
    _calendarSparkle24 = fluentIcon(name = "Filled.CalendarSparkle24", 24f) {
      materialPath {
          ...
          close()
          moveTo(21.0F, 13.936F)
          curveToRelative(-0.151F, 0.072F, -0.329F, 0.114F, -0.54F, 0.114F)
          curveToRelative(-0.96F, 0.0F, -1.23F, -0.857F, -1.466F, -1.606F)
          lineTo(18.98F, 12.4F)
