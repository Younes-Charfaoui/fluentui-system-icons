...
public val FluentIcons.Regular.ArrowExport16: ImageVector
  get() {
    if (_arrowExport16 != null) {
      return _arrowExport16!!
    }
    _arrowExport16 = fluentIcon(name = "Regular.ArrowExport16", 16f) {
      materialPath {
          moveTo(1.5F, 3.0F)
...
private var _arrowExport16: ImageVector? = null
