...
public val FluentIcons.Regular.Storage48: ImageVector
  get() {
    if (_storage48 != null) {
      return _storage48!!
    }
    _storage48 = fluentIcon(name = "Regular.Storage48", 48f) {
      materialPath {
          moveTo(4.0F, 20.25F)
          curveTo(4.0F, 16.798F, 6.798F, 14.0F, 10.25F, 14.0F)
          horizontalLineToRelative(27.5F)
          curveToRelative(3.452F, 0.0F, 6.25F, 2.798F, 6.25F, 6.25F)
          verticalLineToRelative(7.5F)
          curveToRelative(0.0F, 3.452F, -2.798F, 6.25F, -6.25F, 6.25F)
          horizontalLineToRelative(-27.5F)
          curveTo(6.798F, 34.0F, 4.0F, 31.202F, 4.0F, 27.75F)
          verticalLineToRelative(-7.5F)
          close()
