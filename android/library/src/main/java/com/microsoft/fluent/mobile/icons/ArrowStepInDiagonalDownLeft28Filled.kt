...
public val FluentIcons.Filled.ArrowStepInDiagonalDownLeft28: ImageVector
  get() {
    if (_arrowStepInDiagonalDownLeft28 != null) {
      return _arrowStepInDiagonalDownLeft28!!
    }
    _arrowStepInDiagonalDownLeft28 = fluentIcon(name = "Filled.ArrowStepInDiagonalDownLeft28", 28f) {
      materialPath {
          moveTo(23.78F, 5.28F)
