...
public val FluentIcons.Regular.TextBulletList9020: ImageVector
  get() {
    if (_textBulletList9020 != null) {
      return _textBulletList9020!!
    }
    _textBulletList9020 = fluentIcon(name = "Regular.TextBulletList9020", 9020f) {
      materialPath {
          moveTo(5.5F, 17.0F)
          ...
          verticalLineToRelative(11.0F)
          curveTo(5.0F, 13.776F, 4.776F, 14.0F, 4.5F, 14.0F)
          close()
