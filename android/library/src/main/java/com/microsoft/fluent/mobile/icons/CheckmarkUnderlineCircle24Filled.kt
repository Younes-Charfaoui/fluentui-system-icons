...
public val FluentIcons.Filled.CheckmarkUnderlineCircle24: ImageVector
  get() {
    if (_checkmarkUnderlineCircle24 != null) {
      return _checkmarkUnderlineCircle24!!
    }
    _checkmarkUnderlineCircle24 = fluentIcon(name = "Filled.CheckmarkUnderlineCircle24", 24f) {
      materialPath {
          moveTo(12.0F, 2.0F)
          ...
          curveToRelative(-0.414F, 0.0F, -0.75F, -0.336F, -0.75F, -0.75F)
          reflectiveCurveTo(8.086F, 15.0F, 8.5F, 15.0F)
          close()        
      }
    }
    return _checkmarkUnderlineCircle24!!
