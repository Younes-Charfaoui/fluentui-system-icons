...
public val FluentIcons.Regular.TextboxAlignBottomLeft24: ImageVector
  get() {
    if (_textboxAlignBottomLeft24 != null) {
      return _textboxAlignBottomLeft24!!
    }
    _textboxAlignBottomLeft24 = fluentIcon(name = "Regular.TextboxAlignBottomLeft24", 24f) {
      materialPath {
          moveTo(5.75F, 3.0F)
          ...
          curveToRelative(-0.414F, 0.0F, -0.75F, 0.336F, -0.75F, 0.75F)
          reflectiveCurveTo(6.836F, 17.0F, 7.25F, 17.0F)
