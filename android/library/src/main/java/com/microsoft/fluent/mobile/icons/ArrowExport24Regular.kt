...
public val FluentIcons.Regular.ArrowExport24: ImageVector
  get() {
    if (_arrowExport24 != null) {
      return _arrowExport24!!
    }
    _arrowExport24 = fluentIcon(name = "Regular.ArrowExport24", 24f) {
      materialPath {
          moveTo(2.752F, 4.5F)
          ...
          lineToRelative(-4.996F, 5.003F)
          curveToRelative(-0.293F, 0.293F, -0.768F, 0.294F, -1.061F, 0.0F)
          curveToRelative(-0.266F, -0.265F, -0.29F, -0.682F, -0.073F, -0.976F)
          lineToRelative(0.072F, -0.084F)
          lineToRelative(3.711F, -3.717F)
...
private var _arrowExport24: ImageVector? = null
