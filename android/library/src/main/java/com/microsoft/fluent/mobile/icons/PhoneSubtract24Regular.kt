...
public val FluentIcons.Regular.PhoneSubtract24: ImageVector
  get() {
    if (_phoneSubtract24 != null) {
      return _phoneSubtract24!!
    }
    _phoneSubtract24 = fluentIcon(name = "Regular.PhoneSubtract24", 24f) {
      materialPath {
          moveTo(13.75F, 2.0F)
...
private var _phoneSubtract24: ImageVector? = null
