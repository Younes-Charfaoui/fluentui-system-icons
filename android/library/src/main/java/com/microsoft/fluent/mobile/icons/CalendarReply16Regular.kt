...
public val FluentIcons.Regular.CalendarReply16: ImageVector
  get() {
    if (_calendarReply16 != null) {
      return _calendarReply16!!
    }
    _calendarReply16 = fluentIcon(name = "Regular.CalendarReply16", 16f) {
      materialPath {
          moveTo(11.5F, 2.0F)
          ...
          lineTo(8.143F, 11.35F)
          curveToRelative(-0.047F, -0.047F, -0.082F, -0.102F, -0.106F, -0.16F)
          curveTo(8.014F, 11.132F, 8.0F, 11.068F, 8.0F, 11.0F)
...
private var _calendarReply16: ImageVector? = null
