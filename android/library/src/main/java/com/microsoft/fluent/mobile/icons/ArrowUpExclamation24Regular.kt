...
public val FluentIcons.Regular.ArrowUpExclamation24: ImageVector
  get() {
    if (_arrowUpExclamation24 != null) {
      return _arrowUpExclamation24!!
    }
    _arrowUpExclamation24 = fluentIcon(name = "Regular.ArrowUpExclamation24", 24f) {
      materialPath {
          moveTo(18.0F, 4.56F)
          ...
          close()
          moveTo(7.0F, 3.502F)
          curveToRelative(-1.311F, 0.0F, -2.375F, 1.063F, -2.375F, 2.375F)
          curveToRelative(0.0F, 2.624F, 1.114F, 6.03F, 1.72F, 7.682F)
          curveToRelative(0.096F, 0.26F, 0.35F, 0.44F, 0.658F, 0.44F)
          curveToRelative(0.306F, 0.0F, 0.56F, -0.18F, 0.655F, -0.438F)
          curveToRelative(0.606F, -1.64F, 1.718F, -5.03F, 1.718F, -7.684F)
          curveToRelative(0.0F, -1.312F, -1.064F, -2.375F, -2.376F, -2.375F)
          close()
          ...
          close()
          moveToRelative(2.501F, -1.001F)
          curveTo(6.448F, 18.501F, 6.0F, 18.949F, 6.0F, 19.502F)
          curveToRelative(0.0F, 0.553F, 0.448F, 1.001F, 1.001F, 1.001F)
          curveToRelative(0.553F, 0.0F, 1.001F, -0.448F, 1.001F, -1.0F)
