...
public val FluentIcons.Filled.ArrowExport24: ImageVector
  get() {
    if (_arrowExport24 != null) {
      return _arrowExport24!!
    }
    _arrowExport24 = fluentIcon(name = "Filled.ArrowExport24", 24f) {
      materialPath {
          moveTo(2.75F, 4.504F)
          ...
          curveToRelative(-0.39F, 0.39F, -1.024F, 0.391F, -1.415F, 0.0F)
          curveToRelative(-0.36F, -0.36F, -0.388F, -0.927F, -0.084F, -1.32F)
          lineToRelative(0.083F, -0.094F)
          lineTo(18.581F, 13.0F)
