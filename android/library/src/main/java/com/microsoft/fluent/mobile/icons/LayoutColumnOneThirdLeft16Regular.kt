...
public val FluentIcons.Regular.LayoutColumnOneThirdLeft16: ImageVector
  get() {
    if (_layoutColumnOneThirdLeft16 != null) {
      return _layoutColumnOneThirdLeft16!!
    }
    _layoutColumnOneThirdLeft16 = fluentIcon(name = "Regular.LayoutColumnOneThirdLeft16", 16f) {
      materialPath {
          moveTo(4.5F, 2.0F)
