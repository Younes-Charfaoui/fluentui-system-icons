...
public val FluentIcons.Regular.WindowShield16: ImageVector
  get() {
    if (_windowShield16 != null) {
      return _windowShield16!!
    }
    _windowShield16 = fluentIcon(name = "Regular.WindowShield16", 16f) {
      materialPath {
          moveTo(4.5F, 2.0F)
          ...
          curveToRelative(-0.155F, -0.305F, -0.287F, -0.638F, -0.385F, -1.0F)
          horizontalLineTo(4.5F)
          curveTo(3.672F, 13.0F, 3.0F, 12.328F, 3.0F, 11.5F)
          verticalLineTo(6.0F)
          horizontalLineToRelative(10.0F)
          verticalLineToRelative(0.846F)
          curveToRelative(0.286F, 0.247F, 0.627F, 0.49F, 1.0F, 0.66F)
          verticalLineTo(4.5F)
