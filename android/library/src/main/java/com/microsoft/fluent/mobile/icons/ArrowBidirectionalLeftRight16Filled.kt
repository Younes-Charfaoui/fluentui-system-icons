...
public val FluentIcons.Filled.ArrowBidirectionalLeftRight16: ImageVector
  get() {
    if (_arrowBidirectionalLeftRight16 != null) {
      return _arrowBidirectionalLeftRight16!!
    }
    _arrowBidirectionalLeftRight16 = fluentIcon(name = "Filled.ArrowBidirectionalLeftRight16", 16f) {
      materialPath {
          moveTo(6.03F, 5.22F)
