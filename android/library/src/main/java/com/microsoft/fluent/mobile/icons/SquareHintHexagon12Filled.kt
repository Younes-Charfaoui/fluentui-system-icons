...
public val FluentIcons.Filled.SquareHintHexagon12: ImageVector
  get() {
    if (_squareHintHexagon12 != null) {
      return _squareHintHexagon12!!
    }
    _squareHintHexagon12 = fluentIcon(name = "Filled.SquareHintHexagon12", 12f) {
      materialPath {
          moveTo(3.5F, 2.0F)
          ...
          horizontalLineToRelative(-1.0F)
          close()
          moveTo(4.627F, 4.374F)
          curveTo(4.76F, 4.142F, 5.006F, 4.0F, 5.274F, 4.0F)
          horizontalLineToRelative(1.451F)
          curveTo(6.993F, 4.0F, 7.24F, 4.142F, 7.374F, 4.374F)
          lineToRelative(0.724F, 1.249F)
          curveToRelative(0.135F, 0.232F, 0.135F, 0.52F, 0.0F, 0.752F)
          lineToRelative(-0.724F, 1.25F)
          curveTo(7.24F, 7.854F, 6.994F, 7.997F, 6.726F, 7.997F)
          horizontalLineToRelative(-1.45F)
          curveToRelative(-0.268F, 0.0F, -0.515F, -0.142F, -0.65F, -0.374F)
          lineTo(3.902F, 6.375F)
          curveToRelative(-0.135F, -0.232F, -0.135F, -0.52F, 0.0F, -0.752F)
          lineToRelative(0.724F, -1.25F)
          close()        
      }
