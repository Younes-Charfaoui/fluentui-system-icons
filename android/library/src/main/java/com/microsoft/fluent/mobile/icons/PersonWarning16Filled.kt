...
public val FluentIcons.Filled.PersonWarning16: ImageVector
  get() {
    if (_personWarning16 != null) {
      return _personWarning16!!
    }
    _personWarning16 = fluentIcon(name = "Filled.PersonWarning16", 16f) {
      materialPath {
          moveTo(9.267F, 8.0F)
          lineTo(6.29F, 13.964F)
          curveTo(3.58F, 13.684F, 2.0F, 11.818F, 2.0F, 10.0F)
          verticalLineTo(9.5F)
          ...
          curveTo(6.774F, 15.217F, 7.258F, 16.0F, 8.002F, 16.0F)
...
private var _personWarning16: ImageVector? = null
