...
public val FluentIcons.Regular.ScreenshotRecord24: ImageVector
  get() {
    if (_screenshotRecord24 != null) {
      return _screenshotRecord24!!
    }
    _screenshotRecord24 = fluentIcon(name = "Regular.ScreenshotRecord24", 24f) {
      materialPath {
          moveTo(6.25F, 3.0F)
...
private var _screenshotRecord24: ImageVector? = null
