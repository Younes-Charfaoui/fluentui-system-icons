...
public val FluentIcons.Regular.ArrowStepInDiagonalDownLeft24: ImageVector
  get() {
    if (_arrowStepInDiagonalDownLeft24 != null) {
      return _arrowStepInDiagonalDownLeft24!!
    }
    _arrowStepInDiagonalDownLeft24 = fluentIcon(name = "Regular.ArrowStepInDiagonalDownLeft24", 24f) {
      materialPath {
          moveTo(19.78F, 4.28F)
