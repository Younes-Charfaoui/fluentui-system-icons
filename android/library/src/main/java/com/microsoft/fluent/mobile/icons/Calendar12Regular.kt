...
public val FluentIcons.Regular.Calendar12: ImageVector
  get() {
    if (_calendar12 != null) {
      return _calendar12!!
    }
    _calendar12 = fluentIcon(name = "Regular.Calendar12", 12f) {
      materialPath {
          moveTo(3.0F, 5.5F)
          ...
          reflectiveCurveTo(3.776F, 7.0F, 3.5F, 7.0F)
          close()
          moveTo(5.0F, 5.5F)
...
private var _calendar12: ImageVector? = null
