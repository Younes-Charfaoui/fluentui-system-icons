...
public val FluentIcons.Regular.VideoPersonSparkle24: ImageVector
  get() {
    if (_videoPersonSparkle24 != null) {
      return _videoPersonSparkle24!!
    }
    _videoPersonSparkle24 = fluentIcon(name = "Regular.VideoPersonSparkle24", 24f) {
      materialPath {
          ...
          verticalLineToRelative(-3.822F)
          curveToRelative(-0.167F, 0.076F, -0.35F, 0.117F, -0.535F, 0.117F)
          ...
          horizontalLineToRelative(8.123F)
