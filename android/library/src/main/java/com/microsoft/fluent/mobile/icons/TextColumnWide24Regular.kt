...
public val FluentIcons.Regular.TextColumnWide24: ImageVector
  get() {
    if (_textColumnWide24 != null) {
      return _textColumnWide24!!
    }
    _textColumnWide24 = fluentIcon(name = "Regular.TextColumnWide24", 24f) {
      materialPath {
          moveTo(3.75F, 5.0F)
...
private var _textColumnWide24: ImageVector? = null
