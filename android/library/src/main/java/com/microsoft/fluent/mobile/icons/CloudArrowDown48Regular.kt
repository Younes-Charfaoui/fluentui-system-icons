...
public val FluentIcons.Regular.CloudArrowDown48: ImageVector
  get() {
    if (_cloudArrowDown48 != null) {
      return _cloudArrowDown48!!
    }
    _cloudArrowDown48 = fluentIcon(name = "Regular.CloudArrowDown48", 48f) {
      materialPath {
          moveTo(24.0F, 8.5F)
...
private var _cloudArrowDown48: ImageVector? = null
