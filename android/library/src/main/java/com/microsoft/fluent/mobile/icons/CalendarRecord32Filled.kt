...
public val FluentIcons.Filled.CalendarRecord32: ImageVector
  get() {
    if (_calendarRecord32 != null) {
      return _calendarRecord32!!
    }
    _calendarRecord32 = fluentIcon(name = "Filled.CalendarRecord32", 32f) {
      materialPath {
          moveTo(7.5F, 3.0F)
          ...
          curveToRelative(2.071F, 0.0F, 3.98F, 0.7F, 5.5F, 1.875F)
