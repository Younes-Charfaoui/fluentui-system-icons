...
public val FluentIcons.Regular.CalendarSparkle16: ImageVector
  get() {
    if (_calendarSparkle16 != null) {
      return _calendarSparkle16!!
    }
    _calendarSparkle16 = fluentIcon(name = "Regular.CalendarSparkle16", 16f) {
      materialPath {
          ...
          close()
          moveTo(12.95F, 11.88F)
          curveTo(13.121F, 11.958F, 13.309F, 12.0F, 13.5F, 12.0F)
          curveToRelative(0.16F, 0.0F, 0.316F, -0.018F, 0.461F, -0.066F)
          ...
          horizontalLineToRelative(7.0F)
          curveToRelative(0.697F, 0.0F, 1.283F, -0.476F, 1.451F, -1.12F)
          close()        
      }
    }
    return _calendarSparkle16!!
