...
public val FluentIcons.Regular.TextColumnWide20: ImageVector
  get() {
    if (_textColumnWide20 != null) {
      return _textColumnWide20!!
    }
    _textColumnWide20 = fluentIcon(name = "Regular.TextColumnWide20", 20f) {
      materialPath {
          moveTo(3.5F, 5.0F)
...
private var _textColumnWide20: ImageVector? = null
