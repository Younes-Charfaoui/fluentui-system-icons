...
public val FluentIcons.Regular.LayoutColumnTwoSplitRight16: ImageVector
  get() {
    if (_layoutColumnTwoSplitRight16 != null) {
      return _layoutColumnTwoSplitRight16!!
    }
    _layoutColumnTwoSplitRight16 = fluentIcon(name = "Regular.LayoutColumnTwoSplitRight16", 16f) {
      materialPath {
          moveTo(2.0F, 4.5F)
