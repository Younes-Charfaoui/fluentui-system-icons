...
public val FluentIcons.Filled.CalendarRtl32: ImageVector
  get() {
    if (_calendarRtl32 != null) {
      return _calendarRtl32!!
    }
    _calendarRtl32 = fluentIcon(name = "Filled.CalendarRtl32", 32f) {
      materialPath {
          moveTo(3.0F, 7.5F)
          ...
          curveToRelative(0.0F, -0.828F, 0.672F, -1.5F, 1.5F, -1.5F)
          reflectiveCurveToRelative(1.5F, 0.672F, 1.5F, 1.5F)
          reflectiveCurveTo(16.828F, 18.0F, 16.0F, 18.0F)
          reflectiveCurveToRelative(-1.5F, -0.672F, -1.5F, -1.5F)
          close()
