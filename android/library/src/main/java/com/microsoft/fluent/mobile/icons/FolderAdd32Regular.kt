...
public val FluentIcons.Regular.FolderAdd32: ImageVector
  get() {
    if (_folderAdd32 != null) {
      return _folderAdd32!!
    }
    _folderAdd32 = fluentIcon(name = "Regular.FolderAdd32", 32f) {
      materialPath {
          moveTo(4.0F, 8.5F)
          ...
          horizontalLineToRelative(-3.75F)
          curveToRelative(-0.414F, 0.0F, -0.75F, -0.336F, -0.75F, -0.75F)
          reflectiveCurveTo(19.336F, 22.0F, 19.75F, 22.0F)
          horizontalLineToRelative(3.75F)
          verticalLineToRelative(-3.75F)
          curveToRelative(0.0F, -0.414F, 0.336F, -0.75F, 0.75F, -0.75F)
          reflectiveCurveTo(25.0F, 17.836F, 25.0F, 18.25F)
          close()        
      }
    }
    return _folderAdd32!!
...
private var _folderAdd32: ImageVector? = null
