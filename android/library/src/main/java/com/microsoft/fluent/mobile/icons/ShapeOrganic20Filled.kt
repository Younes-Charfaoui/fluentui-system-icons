...
public val FluentIcons.Filled.ShapeOrganic20: ImageVector
  get() {
    if (_shapeOrganic20 != null) {
      return _shapeOrganic20!!
    }
    _shapeOrganic20 = fluentIcon(name = "Filled.ShapeOrganic20", 20f) {
      materialPath {
          ...
          curveToRelative(0.0F, 2.062F, -1.012F, 3.47F, -2.537F, 4.332F)
          curveTo(13.97F, 17.677F, 11.997F, 18.0F, 10.0F, 18.0F)
          curveToRelative(-2.191F, 0.0F, -4.212F, -0.378F, -5.684F, -1.617F)
          ...
          curveToRelative(0.0F, 1.36F, 0.49F, 2.007F, 0.906F, 2.33F)
          close()        
      }
    }
    return _shapeOrganic20!!
...
private var _shapeOrganic20: ImageVector? = null
