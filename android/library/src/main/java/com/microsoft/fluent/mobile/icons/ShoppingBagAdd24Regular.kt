...
public val FluentIcons.Regular.ShoppingBagAdd24: ImageVector
  get() {
    if (_shoppingBagAdd24 != null) {
      return _shoppingBagAdd24!!
    }
    _shoppingBagAdd24 = fluentIcon(name = "Regular.ShoppingBagAdd24", 24f) {
      materialPath {
          moveTo(7.0F, 7.0F)
          verticalLineTo(5.0F)
          ...
          curveToRelative(-0.474F, -0.198F, -0.977F, -0.34F, -1.5F, -0.422F)
          verticalLineTo(8.5F)
          horizontalLineToRelative(-3.99F)
          verticalLineToRelative(3.227F)
          curveToRelative(-0.55F, 0.286F, -1.056F, 0.648F, -1.5F, 1.073F)
          verticalLineTo(8.5F)
