...
public val FluentIcons.Filled.NumberCircle416: ImageVector
  get() {
    if (_numberCircle416 != null) {
      return _numberCircle416!!
    }
    _numberCircle416 = fluentIcon(name = "Filled.NumberCircle416", 416f) {
      materialPath {
          moveTo(1.0F, 8.0F)
          ...
          curveTo(9.777F, 10.0F, 10.0F, 9.776F, 10.0F, 9.5F)
          reflectiveCurveTo(9.777F, 9.0F, 9.5F, 9.0F)
