...
public val FluentIcons.Filled.FolderArrowUp24: ImageVector
  get() {
    if (_folderArrowUp24 != null) {
      return _folderArrowUp24!!
    }
    _folderArrowUp24 = fluentIcon(name = "Filled.FolderArrowUp24", 24f) {
      materialPath {
          moveTo(2.0F, 8.0F)
...
private var _folderArrowUp24: ImageVector? = null
