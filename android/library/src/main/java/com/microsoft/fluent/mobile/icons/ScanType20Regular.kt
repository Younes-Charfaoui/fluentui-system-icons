...
public val FluentIcons.Regular.ScanType20: ImageVector
  get() {
    if (_scanType20 != null) {
      return _scanType20!!
    }
    _scanType20 = fluentIcon(name = "Regular.ScanType20", 20f) {
      materialPath {
          moveTo(4.5F, 3.0F)
          ...
          curveToRelative(-0.276F, 0.0F, -0.5F, -0.224F, -0.5F, -0.5F)
          reflectiveCurveTo(8.724F, 13.0F, 9.0F, 13.0F)
...
private var _scanType20: ImageVector? = null
