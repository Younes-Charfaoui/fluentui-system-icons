...
public val FluentIcons.Filled.Laptop48: ImageVector
  get() {
    if (_laptop48 != null) {
      return _laptop48!!
    }
    _laptop48 = fluentIcon(name = "Filled.Laptop48", 48f) {
      materialPath {
          moveTo(8.0F, 12.25F)
          curveTo(8.0F, 9.903F, 9.903F, 8.0F, 12.25F, 8.0F)
          horizontalLineToRelative(23.5F)
          curveTo(38.097F, 8.0F, 40.0F, 9.903F, 40.0F, 12.25F)
          verticalLineToRelative(15.5F)
          curveToRelative(0.0F, 2.347F, -1.903F, 4.25F, -4.25F, 4.25F)
          horizontalLineToRelative(-23.5F)
          curveTo(9.903F, 32.0F, 8.0F, 30.097F, 8.0F, 27.75F)
          verticalLineToRelative(-15.5F)
          close()
          moveTo(5.25F, 35.5F)
