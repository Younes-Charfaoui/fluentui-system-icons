...
public val FluentIcons.Regular.Resize20: ImageVector
  get() {
    if (_resize20 != null) {
      return _resize20!!
    }
    _resize20 = fluentIcon(name = "Regular.Resize20", 20f) {
      materialPath {
          moveTo(8.5F, 3.0F)
          ...
          close()
          moveTo(5.795F, 15.99F)
          curveTo(4.787F, 15.887F, 4.0F, 15.036F, 4.0F, 14.0F)
          ...
          curveToRelative(0.0F, 1.105F, -0.895F, 2.0F, -2.0F, 2.0F)
          horizontalLineTo(6.0F)
          curveToRelative(-0.069F, 0.0F, -0.137F, -0.004F, -0.205F, -0.01F)
          close()
          moveTo(3.0F, 14.0F)
