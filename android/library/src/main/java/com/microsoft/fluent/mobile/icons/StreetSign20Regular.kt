...
public val FluentIcons.Regular.StreetSign20: ImageVector
  get() {
    if (_streetSign20 != null) {
      return _streetSign20!!
    }
    _streetSign20 = fluentIcon(name = "Regular.StreetSign20", 20f) {
      materialPath {
          moveTo(7.0F, 4.0F)
          ...
          curveTo(13.898F, 6.105F, 13.644F, 6.0F, 13.379F, 6.0F)
          horizontalLineTo(5.0F)
