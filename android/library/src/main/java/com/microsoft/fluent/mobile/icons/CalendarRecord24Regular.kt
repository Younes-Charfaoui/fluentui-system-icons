...
public val FluentIcons.Regular.CalendarRecord24: ImageVector
  get() {
    if (_calendarRecord24 != null) {
      return _calendarRecord24!!
    }
    _calendarRecord24 = fluentIcon(name = "Regular.CalendarRecord24", 24f) {
      materialPath {
          moveTo(17.75F, 3.0F)
...
private var _calendarRecord24: ImageVector? = null
