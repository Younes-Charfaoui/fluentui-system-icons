...
public val FluentIcons.Filled.TextboxAlignTopLeft24: ImageVector
  get() {
    if (_textboxAlignTopLeft24 != null) {
      return _textboxAlignTopLeft24!!
    }
    _textboxAlignTopLeft24 = fluentIcon(name = "Filled.TextboxAlignTopLeft24", 24f) {
      materialPath {
          moveTo(5.75F, 3.0F)
          ...
          horizontalLineToRelative(-6.5F)
          curveToRelative(-0.414F, 0.0F, -0.75F, -0.336F, -0.75F, -0.75F)
          reflectiveCurveTo(6.836F, 11.0F, 7.25F, 11.0F)
          close()        
      }
    }
    return _textboxAlignTopLeft24!!
