...
public val FluentIcons.Regular.ScanTable20: ImageVector
  get() {
    if (_scanTable20 != null) {
      return _scanTable20!!
    }
    _scanTable20 = fluentIcon(name = "Regular.ScanTable20", 20f) {
      materialPath {
          moveTo(4.5F, 3.0F)
...
private var _scanTable20: ImageVector? = null
