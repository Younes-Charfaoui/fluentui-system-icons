...
public val FluentIcons.Regular.TextIndentDecrease24: ImageVector
  get() {
    if (_textIndentDecrease24 != null) {
      return _textIndentDecrease24!!
    }
    _textIndentDecrease24 = fluentIcon(name = "Regular.TextIndentDecrease24", 24f) {
      materialPath {
          moveTo(17.75F, 16.0F)
          ...
          curveToRelative(0.414F, 0.0F, 0.75F, 0.336F, 0.75F, 0.75F)
          reflectiveCurveTo(18.164F, 7.5F, 17.75F, 7.5F)
          horizontalLineToRelative(-9.0F)
          curveTo(8.336F, 7.5F, 8.0F, 7.164F, 8.0F, 6.75F)
          reflectiveCurveTo(8.336F, 6.0F, 8.75F, 6.0F)
          horizontalLineToRelative(9.0F)
          close()        
      }
    }
