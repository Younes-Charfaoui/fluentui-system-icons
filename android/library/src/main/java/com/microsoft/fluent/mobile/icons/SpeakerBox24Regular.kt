...
public val FluentIcons.Regular.SpeakerBox24: ImageVector
  get() {
    if (_speakerBox24 != null) {
      return _speakerBox24!!
    }
    _speakerBox24 = fluentIcon(name = "Regular.SpeakerBox24", 24f) {
      materialPath {
          moveTo(4.0F, 5.25F)
          ...
          reflectiveCurveTo(13.933F, 18.0F, 12.0F, 18.0F)
          reflectiveCurveToRelative(-3.5F, -1.567F, -3.5F, -3.5F)
          close()
          moveTo(12.0F, 9.0F)
