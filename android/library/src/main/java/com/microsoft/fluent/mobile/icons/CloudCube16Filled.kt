...
public val FluentIcons.Filled.CloudCube16: ImageVector
  get() {
    if (_cloudCube16 != null) {
      return _cloudCube16!!
    }
    _cloudCube16 = fluentIcon(name = "Filled.CloudCube16", 16f) {
      materialPath {
          moveTo(8.0F, 2.0F)
...
private var _cloudCube16: ImageVector? = null
