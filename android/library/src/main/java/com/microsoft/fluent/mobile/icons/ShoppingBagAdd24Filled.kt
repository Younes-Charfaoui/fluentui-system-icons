...
public val FluentIcons.Filled.ShoppingBagAdd24: ImageVector
  get() {
    if (_shoppingBagAdd24 != null) {
      return _shoppingBagAdd24!!
    }
    _shoppingBagAdd24 = fluentIcon(name = "Filled.ShoppingBagAdd24", 24f) {
      materialPath {
          moveTo(7.0F, 7.0F)
          verticalLineTo(5.0F)
          ...
          curveTo(19.23F, 11.178F, 18.386F, 11.0F, 17.5F, 11.0F)
          curveToRelative(-1.082F, 0.0F, -2.102F, 0.264F, -3.0F, 0.732F)
          verticalLineTo(7.0F)
          ...
          curveToRelative(-1.233F, 1.182F, -2.0F, 2.847F, -2.0F, 4.69F)
          curveToRelative(0.0F, 1.747F, 0.689F, 3.332F, 1.81F, 4.5F)
...
private var _shoppingBagAdd24: ImageVector? = null
