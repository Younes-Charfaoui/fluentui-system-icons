...
public val FluentIcons.Regular.TextboxAlignTopCenter20: ImageVector
  get() {
    if (_textboxAlignTopCenter20 != null) {
      return _textboxAlignTopCenter20!!
    }
    _textboxAlignTopCenter20 = fluentIcon(name = "Regular.TextboxAlignTopCenter20", 20f) {
      materialPath {
          moveTo(5.5F, 3.0F)
          ...
          curveTo(7.224F, 9.0F, 7.0F, 9.224F, 7.0F, 9.5F)
