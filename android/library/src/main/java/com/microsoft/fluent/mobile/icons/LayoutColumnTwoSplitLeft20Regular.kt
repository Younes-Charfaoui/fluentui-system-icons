...
public val FluentIcons.Regular.LayoutColumnTwoSplitLeft20: ImageVector
  get() {
    if (_layoutColumnTwoSplitLeft20 != null) {
      return _layoutColumnTwoSplitLeft20!!
    }
    _layoutColumnTwoSplitLeft20 = fluentIcon(name = "Regular.LayoutColumnTwoSplitLeft20", 20f) {
      materialPath {
          moveTo(3.0F, 6.0F)
