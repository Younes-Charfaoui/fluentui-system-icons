...
public val FluentIcons.Regular.ClipboardBulletList16: ImageVector
  get() {
    if (_clipboardBulletList16 != null) {
      return _clipboardBulletList16!!
    }
    _clipboardBulletList16 = fluentIcon(name = "Regular.ClipboardBulletList16", 16f) {
      materialPath {
          moveTo(7.0F, 7.5F)
          ...
          close()
          moveTo(5.5F, 8.0F)
          curveTo(5.776F, 8.0F, 6.0F, 7.776F, 6.0F, 7.5F)
          reflectiveCurveTo(5.776F, 7.0F, 5.5F, 7.0F)
...
private var _clipboardBulletList16: ImageVector? = null
