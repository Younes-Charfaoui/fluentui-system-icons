...
public val FluentIcons.Regular.TextBulletList16: ImageVector
  get() {
    if (_textBulletList16 != null) {
      return _textBulletList16!!
    }
    _textBulletList16 = fluentIcon(name = "Regular.TextBulletList16", 16f) {
      materialPath {
          moveTo(2.0F, 4.5F)
...
private var _textBulletList16: ImageVector? = null
