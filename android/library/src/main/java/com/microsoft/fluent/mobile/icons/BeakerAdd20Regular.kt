...
public val FluentIcons.Regular.BeakerAdd20: ImageVector
  get() {
    if (_beakerAdd20 != null) {
      return _beakerAdd20!!
    }
    _beakerAdd20 = fluentIcon(name = "Regular.BeakerAdd20", 20f) {
      materialPath {
          moveTo(14.0F, 3.0F)
          ...
          curveToRelative(-0.331F, 0.091F, -0.65F, 0.212F, -0.952F, 0.36F)
          curveToRelative(-0.057F, -0.286F, -0.086F, -0.578F, -0.086F, -0.871F)
          verticalLineTo(4.0F)
          ...
          curveToRelative(0.1F, 0.348F, 0.231F, 0.683F, 0.393F, 1.0F)
...
private var _beakerAdd20: ImageVector? = null
