...
public val FluentIcons.Regular.LayoutColumnOneThirdRight16: ImageVector
  get() {
    if (_layoutColumnOneThirdRight16 != null) {
      return _layoutColumnOneThirdRight16!!
    }
    _layoutColumnOneThirdRight16 = fluentIcon(name = "Regular.LayoutColumnOneThirdRight16", 16f) {
      materialPath {
          moveTo(4.5F, 2.0F)
