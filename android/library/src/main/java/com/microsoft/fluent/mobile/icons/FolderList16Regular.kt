...
public val FluentIcons.Regular.FolderList16: ImageVector
  get() {
    if (_folderList16 != null) {
      return _folderList16!!
    }
    _folderList16 = fluentIcon(name = "Regular.FolderList16", 16f) {
      materialPath {
          moveTo(2.0F, 4.5F)
          verticalLineTo(6.0F)
          ...
          curveTo(14.844F, 9.03F, 14.675F, 9.0F, 14.5F, 9.0F)
          ...
          curveToRelative(0.066F, 0.186F, 0.168F, 0.356F, 0.297F, 0.5F)
          curveToRelative(-0.13F, 0.144F, -0.23F, 0.314F, -0.297F, 0.5F)
          horizontalLineTo(3.5F)
...
private var _folderList16: ImageVector? = null
