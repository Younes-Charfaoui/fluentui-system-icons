...
public val FluentIcons.Regular.FolderArrowLeft48: ImageVector
  get() {
    if (_folderArrowLeft48 != null) {
      return _folderArrowLeft48!!
    }
    _folderArrowLeft48 = fluentIcon(name = "Regular.FolderArrowLeft48", 48f) {
      materialPath {
          moveTo(6.5F, 12.25F)
          verticalLineTo(16.0F)
          horizontalLineToRelative(10.215F)
          curveToRelative(0.331F, 0.0F, 0.649F, -0.132F, 0.883F, -0.366F)
          lineToRelative(3.384F, -3.384F)
          lineToRelative(-3.384F, -3.384F)
          curveTo(17.364F, 8.632F, 17.046F, 8.5F, 16.715F, 8.5F)
...
private var _folderArrowLeft48: ImageVector? = null
