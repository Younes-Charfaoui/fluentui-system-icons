...
public val FluentIcons.Regular.ClockBill16: ImageVector
  get() {
    if (_clockBill16 != null) {
      return _clockBill16!!
    }
    _clockBill16 = fluentIcon(name = "Regular.ClockBill16", 16f) {
      materialPath {
          moveTo(11.917F, 6.0F)
          curveTo(11.441F, 3.162F, 8.973F, 1.0F, 6.0F, 1.0F)
          curveTo(2.686F, 1.0F, 0.0F, 3.686F, 0.0F, 7.0F)
          reflectiveCurveToRelative(2.686F, 6.0F, 6.0F, 6.0F)
          curveToRelative(0.34F, 0.0F, 0.675F, -0.028F, 1.0F, -0.083F)
          verticalLineTo(11.9F)
          curveTo(6.677F, 11.966F, 6.343F, 12.0F, 6.0F, 12.0F)
          ...
          close()
          moveTo(7.72F, 7.05F)
          curveTo(7.653F, 7.019F, 7.579F, 7.0F, 7.5F, 7.0F)
          horizontalLineTo(6.002F)
          verticalLineTo(4.5F)
          lineTo(5.994F, 4.41F)
          curveTo(5.95F, 4.177F, 5.747F, 4.0F, 5.502F, 4.0F)
          curveToRelative(-0.277F, 0.0F, -0.5F, 0.224F, -0.5F, 0.5F)
          verticalLineToRelative(3.0F)
          lineTo(5.01F, 7.59F)
          curveTo(5.052F, 7.823F, 5.256F, 8.0F, 5.502F, 8.0F)
          horizontalLineTo(7.17F)
          curveToRelative(0.125F, -0.351F, 0.312F, -0.672F, 0.55F, -0.95F)
          close()
          moveTo(14.0F, 7.0F)
...
private var _clockBill16: ImageVector? = null
