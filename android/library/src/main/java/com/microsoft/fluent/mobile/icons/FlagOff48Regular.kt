...
public val FluentIcons.Regular.FlagOff48: ImageVector
  get() {
    if (_flagOff48 != null) {
      return _flagOff48!!
    }
    _flagOff48 = fluentIcon(name = "Regular.FlagOff48", 48f) {
      materialPath {
          ...
          verticalLineTo(11.768F)
          lineTo(28.732F, 30.5F)
          close()
          moveTo(41.25F, 33.0F)
          horizontalLineToRelative(-3.653F)
          lineToRelative(-2.5F, -2.5F)
          horizontalLineToRelative(3.684F)
          lineToRelative(-7.538F, -10.26F)
