...
public val FluentIcons.Regular.PersonAlert16: ImageVector
  get() {
    if (_personAlert16 != null) {
      return _personAlert16!!
    }
    _personAlert16 = fluentIcon(name = "Regular.PersonAlert16", 16f) {
      materialPath {
          moveTo(6.108F, 12.933F)
          curveToRelative(-0.133F, 0.326F, -0.14F, 0.681F, -0.04F, 1.004F)
          curveTo(3.495F, 13.581F, 2.0F, 11.767F, 2.0F, 10.0F)
          verticalLineTo(9.5F)
          curveTo(2.0F, 8.672F, 2.672F, 8.0F, 3.5F, 8.0F)
          horizontalLineToRelative(4.534F)
          curveTo(7.855F, 8.31F, 7.716F, 8.645F, 7.625F, 9.0F)
          horizontalLineTo(3.5F)
          curveTo(3.224F, 9.0F, 3.0F, 9.224F, 3.0F, 9.5F)
          verticalLineTo(10.0F)
          curveToRelative(0.0F, 1.262F, 1.103F, 2.62F, 3.108F, 2.933F)
          close()
          moveTo(7.0F, 1.5F)
          ...
          reflectiveCurveTo(6.034F, 6.0F, 7.0F, 6.0F)
          reflectiveCurveToRelative(1.75F, -0.784F, 1.75F, -1.75F)
          reflectiveCurveTo(7.966F, 2.5F, 7.0F, 2.5F)
          close()
          moveTo(8.5F, 10.0F)
